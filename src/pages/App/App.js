...
class App extends Component {
  ...
  async componentDidMount() {
    ...
    const weatherData = await getCurWeatherByLatLng(lat, lng); //exported to weather-api.js
    this.setState({
      lat,
      lng,
...
// Notes 
//--this.state.icon && is using conditional statement because we want to show the icon when the info is available